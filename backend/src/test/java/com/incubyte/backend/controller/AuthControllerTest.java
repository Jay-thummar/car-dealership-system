...
class AuthControllerTest {
    ...
    void shouldRegisterUserSuccessfully() throws Exception {
        // Arrange
        RegisterRequest request = new RegisterRequest("Jay", "jay@gmail.com", "Password@123");
    ...
    void shouldLoginSuccessfullyAndReturnToken() throws Exception {
        ...
        when(authenticationService.loginAndGenerateToken(any(LoginRequest.class))).thenReturn(token);
